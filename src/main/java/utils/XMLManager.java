...
public class XMLManager {
    public static <T> boolean writeXML(T objeto, String fileName){
        ...
        try{
            ...
            JAXBContext context = JAXBContext.newInstance(objeto.getClass(), Usuario.class,
            CreadorIniciativa.class, HashSetContenedor.class
            );
            //He añadido clases que se pueden serializar.
    ...
    public static <T> T readXML (T objeto, String fileName){
        ...
        try{
            ...
            JAXBContext context = JAXBContext.newInstance(
                    objeto.getClass(),
                    Usuario.class,
                    CreadorIniciativa.class,
                    HashSetContenedor.class
            );
